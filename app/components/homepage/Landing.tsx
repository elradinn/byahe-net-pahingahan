        ...
        <>
            ...
            <div className="py-6 bg-white sm:py-8 lg:py-12">
                <div className="px-4 mx-auto max-w-screen-2xl md:px-8">
                    ...
                    <div className="grid grid-cols-2 gap-6 p-6 bg-gray-100 rounded-lg sm:h-40 sm:content-evenly md:grid-cols-4">
                ...
                <div className="max-w-screen-xl px-4 mx-auto md:px-8">
                    ...
                    <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4 lg:gap-8">
                        <div className="flex flex-col items-center p-4 bg-gray-100 rounded-lg lg:p-8">
                            <div className="w-24 h-24 mb-2 overflow-hidden bg-gray-200 rounded-full shadow-lg md:mb-4 md:h-32 md:w-32">
                                <img
